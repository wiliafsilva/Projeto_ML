...
def load_multiple_seasons(directory_path):
    ...
    if not df_ratings.empty:
        ...
        df_combined = df_combined.merge(
            df_ratings.rename(columns={"Team": "HomeTeam", "Overall": "HOverall", "Attack": "HAttack", "Midfield": "HMidfield", "Defense": "HDefense"}), on=["HomeTeam", "Season"], how="left"
        )

        # Merge para time visitante
        df_combined = df_combined.merge(
            df_ratings.rename(columns={"Team": "AwayTeam", "Overall": "AOverall", "Attack": "AAttack", "Midfield": "AMidfield", "Defense": "ADefense"}), on=["AwayTeam", "Season"], how="left"
        )
        ...
        if missing_count > 0:
            ...
            rating_columns = ["HOverall", "HAttack", "HMidfield", "HDefense", "AOverall", "AAttack", "AMidfield", "ADefense"]
